...
public class MainController {
    ...
    public String index(Model model) {
        //Получаем объект аутентификации -> с помощью SecurityContextHolder
        //обращаемся к контексту и на нем вызываем метод аутентификации.
        //Из сесии текущего пользователя получаем объект, который
        //был положен в сессию после аутентификации пользователя.
...
//    }
    ...
    public String deleteProductFromCart(Model model, @PathVariable("id") int id) {
        ...
        cartRepository.deleteCartByProductById(id);
        return "redirect:/cart";
    }
    ...
    public String order() {
        ...
        for(Product product : productList) {
            ...
            cartRepository.deleteCartByProductById(product.getId());
        }
